const projects = [
    {
        title: "ZihKing Music Webstore",
        url: "https://github.com/Sharlmagne/zihking-mern-app",
        description: "A web application implemented with MERN stack. It allows users to browse and preview products (music instrumentals), add licenses to their cart, and place orders.  It provides RESTful APIs for handling various functionalities, such as authentication, file uploads, email sending, and interacting with external services like AWS S3, AWS CloudFront, and PayPal Checkout.",
    ...
    },
    {
        ...
        image: "images/nis-inspector.png"
    },
    {
        title: "Revlent Landing Page",
